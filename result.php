...
<!-- shopping_card container start here-->
            <div class="shopping_card">
               <span style="float:right; font-size:18px;padding:5px;line-height:40px">
                 ...
                 <a href="cart.php" style="color:pink">Go to Card</a>
            ...
            if(isset($_GET['search'])){
              $search_quary = $_GET['user_quary'];

              $get_pro = "SELECT * FROM product where product_keword like '%$search_quary%'";
                   ...
                   <h3>$pro_title</h3>
                    <img src='admin area/imgs/$pro_img' width='180' height='180'/>
                     ...
                     <a href='details.php?pro_id =$pro_id'  style='float:left'>Details</a>
                        <a href='index.php?pro_id =$pro_id'><button  style='float:right'>Add to Card</a>
